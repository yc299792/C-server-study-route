...
int main(int argc, char** argv){
    ...
    for(int i = 0; i < 10000; i++){
        sprintf(url, "https://github.com/%d.html", i);
    ...
    char* str = "https://github.com/0.html";
    if (0 == BloomFilter_Check(&stBloomFilter, (const void*)str, strlen(str)) ){
        printf("https://github.com/0.html exist\n");
    }

    char* str2 = "https://github.com/10001.html";
    if (0 != BloomFilter_Check(&stBloomFilter, (const void*)str2, strlen(str2)) ){
          printf("https://github.com/10001.html not exist\n");
    }
